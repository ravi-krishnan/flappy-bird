let game_loop, object_creation_loop;
function main(){
    // ✅
            ...
            if(is_game_over == false){
                switch(key){
                    case 'ArrowUp':
                        ...
                        break;
                    case 'ArrowDown':
                        flappy_bird.style.gridRowStart = Math.max(flappy_bird_row - 1, 1);
                        break;
                    case 'ArrowLeft':
                        flappy_bird.style.gridColumnStart = Math.max(flappy_bird_col - 1, 1);
                        break;
                    case 'ArrowRight':
    ...
    const flappy = document.getElementById('flappy-bird');
    flappy.style.gridRowStart = 10;
    flappy.style.gridColumnStart = 5;
